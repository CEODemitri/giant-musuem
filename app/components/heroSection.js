          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg md:text-xl text-neutral-500/70 max-w-xl text-pretty leading-relaxed">
                ...
                introperspectives. Groundbreaking showcase featuring{" "}
                <span className="font-bold">5000+</span> works from the not so
                distant past.
              </p>
              ...
              <div className="flex items-center gap-8 pt-6">
                <div>
                  <div className="text-3xl font-bold text-neutral-500/70">
                    500+
                  </div>
                ...
                <div>
                  ...
                  <div className="text-sm text-neutral-500/50">
                    Limited Time
                  </div>
                </div>
              </div>

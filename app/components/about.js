...
export function AboutGrid() {
  return (
    <section className="py-8 lg:py-12 bg-neutral-500/10 rounded-lg">
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12">
        <div className="mb-12">
          ...
          <p className="text-lg max-w-2xl">
            Explore our curated collections, upcoming exhibitions, and exclusive
            events.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-[280px]">
          ...
          <Card className="md:col-span-2 lg:row-span-2 overflow-hidden group cursor-pointer hover:shadow-xl transition-shadow">
            <div className="relative h-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <button className="bg-white">Explore Collection</button>
              </div>
            </div>
          </Card>

          {/* Visit info */}
          <Card className="p-6 flex flex-col justify-between bg-[var(--primary)]">
            <div>
            ...
            <button className="mt-4 w-full border">Plan Your Visit</button>
          </Card>
          ...
          <Card className="p-6 flex flex-col justify-between">
            ...
            <button className="mt-4 w-full">View All Events</button>
          </Card>
          ...
          <Card className="overflow-hidden group cursor-pointer">
            <div className="relative h-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                <h3 className="text-xl font-bold">Museum Shop</h3>
              </div>
            </div>
          </Card>
